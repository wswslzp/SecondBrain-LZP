# AGENTS.md — Second Brain Schema

This file tells Codex how to operate on this Obsidian vault. It is the schema layer of the LLM Wiki pattern.

## Architecture

This vault has three layers:

- **`raw/`** — Immutable source documents (articles, papers, clippings). Codex reads but NEVER modifies these. `raw/assets/` stores downloaded images and attachments.
- **`wiki/`** — LLM-generated and maintained markdown pages. Summaries, entity pages, concept pages, comparisons, synthesis. Codex owns this layer entirely.
